...
<div class="container mb-5">
  <div class="row">
    ...
    <div class="col">
      <button type="button" class="btn btn-lg btn-outline-danger" data-toggle="modal" data-target="#bd-example-modal-xl">削除</button>
      <!-- Modal -->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="bd-example-modal-xl">本当に削除しますか？</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              削除する内容を確認した後、削除ボタンを押してください。
            </div>
